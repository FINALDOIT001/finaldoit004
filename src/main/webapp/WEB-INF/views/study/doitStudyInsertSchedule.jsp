   ...
   <section class="about_part section-padding">
      <div class="container">
         <div class="row">
            ...
            <div class="offset-lg-1 col-lg-5 col-sm-8 col-md-6">
               <div class="about_text">
                  <form action="" class="was-validated"> <!-- 폼 태그 시작 부분 나중에 추가-->
                     ...
                     <div class="row">
                        <div class="col">
                       <input type="text" class="form-control" placeholder="공부 주제 입력" name="studytitle" required>
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                        <div class="col">
                          <input type="text" class="form-control addressmagin" placeholder="주소 자동 입력" name="addddd" required>
                        </div>
                        <div class="col">
                          <input type="button" class="genric-btn danger radius" style="margin-bottom: 10px; font-size: 13px;" value="우편번호 찾기"></button>
                        </div>
                     </div>
                      <div class="row">
                        <div class="col">
                       <input type="text" class="form-control addressmagin"  placeholder="주소 자동 입력" name="addd" required>
                        </div>
                        </div>
                        <div class="row">
                     <div class="col">
                     <input type="text" class="form-control" placeholder="주소 상세 입력" name="adddd" required>
                  </div>
                     </div>
                     <br>
                     <br><br>
            ...
            <hr>
            <div style="text-align: center; padding-top: 20px; padding-bottom: 20px;"><h2>About Schedule</h2></div>
